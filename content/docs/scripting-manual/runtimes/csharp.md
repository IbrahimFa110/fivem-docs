...
Before you can create your first C# resource, you'll need to install [Visual Studio 2019](https://visualstudio.microsoft.com/vs/) (the community/free version will work just fine).


## Creating your project
1. Open Visual Studio, and click `File > New > Project`. A window should pop up that looks something like the window below:
![screenshot-1](https://cdn.discordapp.com/attachments/592482721209516033/658291747390095371/unknown.png) add in new
2. Make sure you select **C#** in the dropdown menu **All languages**, then choose **Class Library (.NET Framework)** then click **Next**.
<br>It's very important that you select the correct project type, as otherwise your resource will **not** run.
3. After selecting the project type, make sure you set the Framework version to **.NET Framework 4.5.2** (Select from the dropdown menu). Yes, this is **not** the latest version, but this specific version is required for your resource to work correctly.
...
5. After choosing a proper name, you can select a location.
### Additional project
...
2. Then go to the "Application" tab on the left, and in there add `.net` at the end of the "Assembly name". Now press CTRL + S to save this change. ![screenshot-2](https://cdn.discordapp.com/attachments/592482721209516033/658294613446098984/unknown.png)
...
The following window should appear: ![screenshot-3](https://cdn.discordapp.com/attachments/592482721209516033/658296281747292179/unknown.png)
